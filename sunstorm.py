...
def prep_restore(ipsw, blob, board, kpp, legacy, skip_baseband):
    ...
    subprocess.run(['/bin/cp', 'work/ramdisk/usr/lib/libimg4.dylib', 'work/libimg4.patched'])
    ...
    subprocess.run(['/usr/local/bin/ldid', '-Swork/libimg4.plist', 'work/libimg4.patched'])
